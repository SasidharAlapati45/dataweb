...
@route('/')
def hello_world():
    return 'Hello from Sasidhar Alapati!'

@route('/hi')
def hi_world():
    return 'Hi from Sasidhar Alapati!'

@route('/bye')
def bye_world():
    return 'Bye from Sasidhar Alapati!'
...
def get_list():
    ...
    return template("shopping_list.tpl", name="Sasidhar Alapati", shopping_list=rows)
